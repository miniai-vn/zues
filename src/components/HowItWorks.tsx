...
const HowItWorks = () => {
  ...
  const stepsData = [
    {
      number: "01",
      title: t("howItWorks.steps.requestAccess.title"),
      description: t("howItWorks.steps.requestAccess.description"),
      image:
        "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80",
    },
    {
      number: "02",
      title: t("howItWorks.steps.personalization.title"),
      description: t("howItWorks.steps.personalization.description"),
      image:
    ...
    {
      number: "04",
      title: t("howItWorks.steps.adaptation.title"),
      description: t("howItWorks.steps.adaptation.description"),
      image:
        "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80",
    },
  ];
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-dark-900/70 to-transparent">
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <span className="text-pulse-400 font-medium mb-2 block">
                      {step.number}
                    </span>
