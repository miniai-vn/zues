...
const HumanoidSection = () => {
  ...
  return (
    <div ref={sectionRef} className="relative" style={{ height: "300vh" }}>
      <section
        className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-[hsl(var(--background))]"
        id="why-humanoid"
      >
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          >
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-[hsl(var(--primary)/0.4)] to-[hsl(var(--background)/0.8)]"
                style={{
