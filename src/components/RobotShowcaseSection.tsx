        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>{t("robotShowcase.badge")}</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              {t("robotShowcase.title.part1")}{" "}
              <span className="text-[#FC4D0A]">
                {t("robotShowcase.title.part2")}
              </span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              {t("robotShowcase.description")}
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">
                    {t("robotShowcase.card.title")}
                  </h3>
                  <p className="text-white/80">
                    {t("robotShowcase.card.subtitle")}
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">
                {t("robotShowcase.features.sensors.title")}
              </h4>
              <p className="text-gray-600">
                {t("robotShowcase.features.sensors.description")}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">
                {t("robotShowcase.features.learning.title")}
              </h4>
              <p className="text-gray-600">
                {t("robotShowcase.features.learning.description")}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">
                {t("robotShowcase.features.movement.title")}
              </h4>
              <p className="text-gray-600">
                {t("robotShowcase.features.movement.description")}
              </p>
            </div>
          </div>
        </div>
